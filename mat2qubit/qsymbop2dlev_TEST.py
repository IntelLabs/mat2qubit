...
class symb2qubit_test(unittest.TestCase):
    ...
    def test_conversion(s):
        ...
        ssid_order = ['1','v2','v3'] # List or tuple. Will define ssid --> numeric ssid
        ...
        # *** Test globalop3 ***
        dlevCompOp = symbop_to_dlevcompositeop(s.globalop3, ssid_order,ssid_to_d,ssid_to_enc)

        # print(dlevCompOp)
        s.assertEqual( str(dlevCompOp), 
            "[(1.0, ((0, 'q'), (1, 'qhoMom'))), (1.4, ((0, 'q'), (2, 'numop')))]" )


        # *** Test identity - alone ***
        dlevCompOp_ident = symbop_to_dlevcompositeop( qSymbOp.qSymbOp('7 [ ]'),  [],{},{} )
        s.assertEqual( str(dlevCompOp_ident) , "[(7.0, 'ident')]" )



        # *** Test identity - with other ops ***
        dlevCompOp = symbop_to_dlevcompositeop( qSymbOp.qSymbOp('7 [ ] ++ [q_1 p_v2]'),  
                    ssid_order,ssid_to_d,ssid_to_enc)
        s.assertEqual( str(dlevCompOp) , "[(7.0, 'ident'), (1.0, ((0, 'q'), (1, 'qhoMom')))]" )
        ...
        s.assertEqual( str(dlevCompOp) , "[(1.0, ((0, 'q'), (1, 'qhoMom'))), (1.4, ((1, 'q'), (2, 'numop')))]" )
        ...
        op = qSymbOp.qSymbOp('[q_a p_b] ++ 1.4 [q_b n_c]')
        dlevCompOp = symbop_to_dlevcompositeop( op, ['a','b','c'], [4,5,6], ['gray','unary','stdbinary'] )
        s.assertEqual( str(dlevCompOp) , "[(1.0, ((0, 'q'), (1, 'qhoMom'))), (1.4, ((1, 'q'), (2, 'numop')))]" )
    ...
    def test_symbop_pauli_to_mat(s):
        ...
        res1 = symbop_pauli_to_mat('2.1 [X_0 Y_2 Z_3]', [str(i) for i in range(4)] ).toarray()
        res2 = symbop_pauli_to_mat('7 [ ] ++ [X_1 Y_1]', [str(i) for i in range(2)] ).toarray()
