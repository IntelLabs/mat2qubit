...
class i2b_tests(unittest.TestCase):
    ...
    def test_num_mappings(s):
        ...
        lmax = 11
        s.assertEqual(
            i2b.dec2blockunary(0, lmax, g, locEncFunc), [1, 0, 0, 0, 0, 0, 0, 0]
        )
        s.assertEqual(
            i2b.dec2blockunary(1, lmax, g, locEncFunc), [0, 1, 0, 0, 0, 0, 0, 0]
        )
        s.assertEqual(
            i2b.dec2blockunary(2, lmax, g, locEncFunc), [1, 1, 0, 0, 0, 0, 0, 0]
        )
        s.assertEqual(
            i2b.dec2blockunary(3, lmax, g, locEncFunc), [0, 0, 1, 0, 0, 0, 0, 0]
        )
        s.assertEqual(
            i2b.dec2blockunary(4, lmax, g, locEncFunc), [0, 0, 0, 1, 0, 0, 0, 0]
        )
        s.assertEqual(
            i2b.dec2blockunary(5, lmax, g, locEncFunc), [0, 0, 1, 1, 0, 0, 0, 0]
        )
        s.assertEqual(
            i2b.dec2blockunary(6, lmax, g, locEncFunc), [0, 0, 0, 0, 1, 0, 0, 0]
        )
        s.assertEqual(
            i2b.dec2blockunary(7, lmax, g, locEncFunc), [0, 0, 0, 0, 0, 1, 0, 0]
        )
        s.assertEqual(
            i2b.dec2blockunary(8, lmax, g, locEncFunc), [0, 0, 0, 0, 1, 1, 0, 0]
        )
        s.assertEqual(
            i2b.dec2blockunary(9, lmax, g, locEncFunc), [0, 0, 0, 0, 0, 0, 1, 0]
        )
        s.assertEqual(
            i2b.dec2blockunary(10, lmax, g, locEncFunc), [0, 0, 0, 0, 0, 0, 0, 1]
        )
        s.assertEqual(
            i2b.dec2blockunary(11, lmax, g, locEncFunc), [0, 0, 0, 0, 0, 0, 1, 1]
        )
        ...
        s.assertEqual(
            i2b.dec2blockunary(1, lmax, g, locEncFunc), [1, 1, 0, 0, 0, 0, 0, 0]
        )
        s.assertEqual(
            i2b.dec2blockunary(2, lmax, g, locEncFunc), [0, 1, 0, 0, 0, 0, 0, 0]
        )
        s.assertEqual(
            i2b.dec2blockunary(3, lmax, g, locEncFunc), [0, 0, 1, 0, 0, 0, 0, 0]
        )
        s.assertEqual(
            i2b.dec2blockunary(4, lmax, g, locEncFunc), [0, 0, 1, 1, 0, 0, 0, 0]
        )
        s.assertEqual(
            i2b.dec2blockunary(5, lmax, g, locEncFunc), [0, 0, 0, 1, 0, 0, 0, 0]
        )
        s.assertEqual(
            i2b.dec2blockunary(6, lmax, g, locEncFunc), [0, 0, 0, 0, 1, 0, 0, 0]
        )
        ...
        s.assertEqual(
            i2b.dec2blockunary(8, lmax, g, locEncFunc), [0, 0, 0, 0, 0, 1, 0, 0]
        )
        s.assertEqual(
            i2b.dec2blockunary(9, lmax, g, locEncFunc), [0, 0, 0, 0, 0, 0, 1, 0]
        )
        s.assertEqual(
            i2b.dec2blockunary(10, lmax, g, locEncFunc), [0, 0, 0, 0, 0, 0, 1, 1]
        )
        s.assertEqual(
            i2b.dec2blockunary(11, lmax, g, locEncFunc), [0, 0, 0, 0, 0, 0, 0, 1]
        )
        ...
        lmax = 11
        s.assertEqual(
            i2b.dec2blockunary(0, lmax, g, locEncFunc), [1, 0, 0, 0, 0, 0, 0, 0, 0]
        )
        s.assertEqual(
            i2b.dec2blockunary(1, lmax, g, locEncFunc), [1, 1, 0, 0, 0, 0, 0, 0, 0]
        )
        s.assertEqual(
            i2b.dec2blockunary(2, lmax, g, locEncFunc), [0, 1, 0, 0, 0, 0, 0, 0, 0]
        )
        s.assertEqual(
            i2b.dec2blockunary(3, lmax, g, locEncFunc), [0, 1, 1, 0, 0, 0, 0, 0, 0]
        )
        s.assertEqual(
            i2b.dec2blockunary(4, lmax, g, locEncFunc), [1, 1, 1, 0, 0, 0, 0, 0, 0]
        )
        s.assertEqual(
            i2b.dec2blockunary(5, lmax, g, locEncFunc), [0, 0, 0, 1, 0, 0, 0, 0, 0]
        )
        s.assertEqual(
            i2b.dec2blockunary(6, lmax, g, locEncFunc), [0, 0, 0, 1, 1, 0, 0, 0, 0]
        )
        s.assertEqual(
            i2b.dec2blockunary(7, lmax, g, locEncFunc), [0, 0, 0, 0, 1, 0, 0, 0, 0]
        )
        s.assertEqual(
            i2b.dec2blockunary(8, lmax, g, locEncFunc), [0, 0, 0, 0, 1, 1, 0, 0, 0]
        )
        s.assertEqual(
            i2b.dec2blockunary(9, lmax, g, locEncFunc), [0, 0, 0, 1, 1, 1, 0, 0, 0]
        )
        s.assertEqual(
            i2b.dec2blockunary(10, lmax, g, locEncFunc), [0, 0, 0, 0, 0, 0, 1, 0, 0]
        )
        s.assertEqual(
            i2b.dec2blockunary(11, lmax, g, locEncFunc), [0, 0, 0, 0, 0, 0, 1, 1, 0]
        )
        ...
        g = 3
        s.assertEqual(
            i2b.dec2blockunary(0, 0, g, locEncFunc), [1, 0]
        )  # lmax=inp for all these
        s.assertEqual(
            i2b.dec2blockunary(1, 1, g, locEncFunc), [1, 1]
        )  # lmax=inp for all these
        s.assertEqual(
            i2b.dec2blockunary(2, 2, g, locEncFunc), [0, 1]
        )  # lmax=inp for all these
        s.assertEqual(
            i2b.dec2blockunary(3, 3, g, locEncFunc), [0, 0, 1, 0]
        )  # lmax=inp for all these
        s.assertEqual(
            i2b.dec2blockunary(4, 4, g, locEncFunc), [0, 0, 1, 1]
        )  # lmax=inp for all these
        s.assertEqual(
            i2b.dec2blockunary(5, 5, g, locEncFunc), [0, 0, 0, 1]
        )  # lmax=inp for all these
        s.assertEqual(
            i2b.dec2blockunary(6, 6, g, locEncFunc), [0, 0, 0, 0, 1, 0]
        )  # lmax=inp for all these
        ...
        s.assertEqual(
            i2b.getBitMask(
                0, 0, "blockunary", {"g": g, "localEncodingFunc": locEncFunc}
            ),
            [1, 1],
        )  # lmax=inp for all these
        s.assertEqual(
            i2b.getBitMask(
                1, 1, "blockunary", {"g": g, "localEncodingFunc": locEncFunc}
            ),
            [1, 1],
        )
        s.assertEqual(
            i2b.getBitMask(
                2, 2, "blockunary", {"g": g, "localEncodingFunc": locEncFunc}
            ),
            [1, 1],
        )
        s.assertEqual(
            i2b.getBitMask(
                3, 3, "blockunary", {"g": g, "localEncodingFunc": locEncFunc}
            ),
            [0, 0, 1, 1],
        )
        s.assertEqual(
            i2b.getBitMask(
                4, 4, "blockunary", {"g": g, "localEncodingFunc": locEncFunc}
            ),
            [0, 0, 1, 1],
        )
        s.assertEqual(
            i2b.getBitMask(
                5, 5, "blockunary", {"g": g, "localEncodingFunc": locEncFunc}
            ),
            [0, 0, 1, 1],
        )
        s.assertEqual(
            i2b.getBitMask(
                6, 6, "blockunary", {"g": g, "localEncodingFunc": locEncFunc}
            ),
            [0, 0, 0, 0, 1, 1],
        )
    ...
    def test_generalfunc(s):
        ...
        s.assertEqual(
            i2b.int2bits(7, lmax, "blockunary", {"g": g, "localEncodingFunc": "gray"}),
            [0, 0, 0, 0, 1, 1, 0, 0],
        )  # string for local function
    ...
    def test_bitmasks(s):
        ...
        s.assertEqual(
            i2b.getBitMask(3, 7, "unary"),
            [False, False, False, True, False, False, False, False],
        )

        # For block unary, it's only the block on which the current number sits
        s.assertEqual(
            i2b.getBitMask(9, 11, "blockunary", {"g": 5}), [0, 0, 0, 1, 1, 1, 0, 0, 0]
        )
        s.assertEqual(
            i2b.getBitMask(10, 11, "blockunary", {"g": 5}), [0, 0, 0, 0, 0, 0, 1, 1, 1]
        )
